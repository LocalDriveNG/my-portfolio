...
const SkillsSection = () => {
  const skillCategories = [{
    ...
    skills: ["Pivot Tables & Pivot Charts", "Advanced Functions (VLOOKUP, INDEX-MATCH)", "Interactive Dashboards", "Data Cleaning & Transformation", "KPI Reporting"]
  }, {
    title: "SQL",
    icon: Database,
    color: "from-blue-500 to-cyan-600",
    skills: ["Complex Joins & Subqueries", "Common Table Expressions (CTEs)", "Data Aggregation & Analysis", "Database Manipulation", "Query Optimization"]
  }, {
    title: "Power BI",
    icon: BarChart3,
    color: "from-amber-500 to-orange-600",
    skills: ["DAX Formulas", "Interactive Dashboards", "Data Modeling", "Report Design", "Business Intelligence"]
  }, {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
            ...
            {skillCategories.map((category, index) => <Card key={index} variant="glow" className="group overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <ul className="space-y-3">
                    {category.skills.map((skill, skillIndex) => <li key={skillIndex} className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {additionalSkills.map((skill, index) => <Card key={index} variant="glass" className="group">
