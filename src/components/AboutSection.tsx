        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">I am an Application/Data Analyst and Frontend Web Developer with over 4 years of experience transforming raw data into actionable business insights and building modern web applications.</p>
